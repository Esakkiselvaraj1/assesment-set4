...
console.log(sumOfToNumber(5, 15));
...
console.log(findLargestNumber(5, 10, 15, 0, 100, 200, 300, 400, 500, -100));
...
console.log(reverseOrder("Hello, word!"));
...
function findCombinations(numbers, targetSum) {
  ...
  function backtrack(index, currentSum) {
    ...
    for (let i = index; i < numbers.length; i++) {
      backtrack(i, currentSum + numbers[i]);
    }
  }
